...
ggplot(responses, aes(x = equipped_to_lead)) +
  ...
  theme_minimal() +
  theme(text = element_text(colour = "#562431", family = "Trebuchet MS"),
        axis.text = element_text(colour = "#562431"),
...
#                c(learning_relevance, equipped_to_lead),
...
make_table <- function(data, column) {
