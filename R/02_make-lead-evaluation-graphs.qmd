...
## TODO: 'capture' all plots within global environment, package them as a list and save as RDS. Demonstrated w/ this plot.
...
## Still printed in rendered doc via explict call
equipped_to_lead_bar
```
